# DD_ImgCopyResized
A reliable and extensible php library > do first resize > than crop image to fix width and height without losing dimension ratio in a user-friendly and simple way.
