...
The desired storage location, final height, final width, quality, and the image file in .jpg, .gif, or .png format can be included as a parameter in the method.
